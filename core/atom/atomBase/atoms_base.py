...
Atoms_info: Dict[str, tuple(str)] = {"H": ("Hydrogen", "Atomic Number : 1"), "He": ("Helium", "Atomic Number : 2"), "Li": ("Lithium", "Atomic Number : 3"),"Be": ("Beryllium", "Atomic Number : 4"),
...
class AtomBase(metaclass=ABCMeta):
    ...
    @property
    @abstractmethod
    def getNeutrons() -> None:...
    @property
    @abstractmethod
    def getElectrons() -> None:...
    @property
    @abstractmethod
    def getAtomicMass() -> None:...
    @property
    @abstractmethod
    def getAtomicNumber() -> None:...
    @property
    @abstractmethod
    def getGroup() -> None:...
    @property
    @abstractmethod
    def getElecConfig() -> None:...
    @property
    @abstractmethod
    def getElecPerShell() -> None:...
    @property
    @abstractmethod
    def getPhaseAtSTP() -> None:...
    @property
    @abstractmethod
    def getMeltingPoint() -> None:...
    @property
    @abstractmethod
    def getBoilingPoint() -> None:...
    @property
    @abstractmethod
    def getIsotopes() -> None:...
    @property
    @abstractmethod
    def getFullName()-> None:...
